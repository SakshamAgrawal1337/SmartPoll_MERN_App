...
// NOTE: Mail functionality intentionally disabled for this build.
import {
...
const register = async ({ name, email, password, role }) => {
  ...
  // Mail functionality disabled: generate verification token in DB only.
  // try {
...
// Issues a new access token using a valid refresh token getting 206
